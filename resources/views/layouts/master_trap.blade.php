...
<head>
  ...
  {!!Html::style('css/csSebas.css?v=2.0.4')!!}

</head>
<body>
  <div class="row">
    <div class="col-md-1 bb-dev-color">
      <a href="http://www.trasteosmanizales.com/wp-admin/edit.php?post_type=product" target="_blank">
        <img src="{{ asset('img/fondo-1.png') }}">
      </a>
    </div>
    <!-- BODY SEGUNDO -->
    <div class="col-md-11">
      ...
      <div class="row">
        <div class="col-md-12 bb-dev-color">
          <a href="http://www.trasteosmanizales.com/wp-admin/edit.php?post_type=product" target="_blank">
            <img src="{{ asset('img/fondo-2.png') }}">
          </a>
        </div>
        <div class="col-md-12">
          <a href="http://www.trasteosmanizales.com/wp-admin/edit.php?post_type=product" target="_blank">
            <img src="{{ asset('img/fondo-3.png') }}">
          </a>
        </div>
      </div>
      <br>
      ...
      <body-segundo class="active-tramp">
        ...
        <!-- my Scripts -->
        {!!Html::script('js/jSebas.js?v=3.3.3')!!}
